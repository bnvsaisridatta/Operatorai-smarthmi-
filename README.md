...
🔗 **Live Demo:** https://bnvsaisridatta.github.io/Operator-AI-smart-HMI/
...
- Grouping related alarms into **single incidents** with a root cause
- Scoring each incident by urgency, cascade count, and trend direction
- Showing **role-specific guidance** (Operator / Engineer / Supervisor) for the same incident
- Narrating situations in **plain English** instead of alarm codes
...
| **S3 — Power Spike** | Overload at 97% capacity | Motor heating → Imminent P1 trip risk |
...
### 10-Sensor Live Telemetry

Pump P1 State · Pump P2 (Backup) · Motor Temperature · Inlet Flow Rate · Inlet Tank Level · Outlet Tank Level · System Pressure · Valve V1 State · Power Load · Valve V2 State
...
| Charts & Telemetry | CSS-driven sensor bars with live state |
| Simulation | JavaScript timers + inline JSON scenario data |
...
- **Organizer:** MyCareernet · [Contest Page](https://mycareernet.co/mycareernet/contests/ABB-ABB-Accelerator-280)
